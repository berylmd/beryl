...
import { setupTestAdapter, setFileContent, resetWriteHistory } from '../src/lib/workspace/adapters/test'
...
test.describe('File watcher — external changes', () => {
  ...
  test('new task added externally appears in UI', async ({ page }) => {
    ...
    await setFileContent(page, '/test-workspace/inbox.md', `- [ ] Original task\n- [ ] Externally added task\n`)
